...
class DTLS_Reconnection_Test : public Test
   ...
   public:
      std::vector<Test::Result> run() override
         ...
         Botan::TLS::Client client1(client1_callbacks, client_sessions, creds, policy, rng(),
         ...
         Botan::TLS::Client client2(client2_callbacks, client_sessions, creds, policy, rng(),
                                    Botan::TLS::Server_Information("localhost"),
                                    Botan::TLS::Protocol_Version::latest_dtls_version());
